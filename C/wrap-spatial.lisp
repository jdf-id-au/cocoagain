...
(defconstant +omit-fns+
  ;; Derived from compiler feedback on earlier wrap_spatial.m versions, plus simplification of redundancy
  '(
...
(defun lispify (parsed)
  ...
  (let* ((defuns
    ...
    `(progn "Autogenerated by wrap-spatial, do not edit." ,@defuns)))

#+nil(;; Output C file for massaging and compilation.
      ...
      ;; Create ergonomic lisp fns (for copypaste to spatial.lisp)
